...
test('[2] tüm resimlerin linkleri doğru sıralama ile eklenmiş', () => {
  ...
  expect(elements[0].src).toBe(
    'https://i.ibb.co/fnym2jF/food-avocadotoast.jpg'
  );
  expect(elements[1].src).toBe('https://i.ibb.co/CBbdF88/food-burger.jpg');
  expect(elements[2].src).toBe(
    'https://i.ibb.co/fDqgbzW/food-chickenfingers.jpg'
  );
  expect(elements[3].src).toBe('https://i.ibb.co/Jj3tPqs/food-poutine.jpg');
  expect(elements[4].src).toBe('https://i.ibb.co/7bVYTyd/food-ribs.jpg');
  expect(elements[5].src).toBe('https://i.ibb.co/dMt2Dwz/food-sandwich.jpg');
  expect(elements[6].src).toBe('https://i.ibb.co/6Y8DgvK/food-sausage.jpg');
  expect(elements[7].src).toBe('https://i.ibb.co/nwgdHQ4/food-steak.jpg');
  expect(elements[8].src).toBe('https://i.ibb.co/bFmCDtk/food-tacos.jpg');
});
